      ...
      >
        <div class="tpl-create-content">
          ...
          <div style="text-align: center">
            <el-button
              type="primary"
              @click="dialogFormVisibleName===1?submitForm('ruleForm'):editForm('ruleForm')"
            >提交</el-button>
  ...
  methods: {
    selectTaskType() {
      if (this.ruleForm.category === '') {
        ...
        this.contentOptions.mode = this.ruleForm.category
      }
    ...
    handleEdit(row) {
      ...
      taskDetails(row.taskId).then(response => {
        this.ruleForm = {
